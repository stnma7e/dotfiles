...
mydateclock = wibox.widget.textclock("%b %d  ", 1)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.all, taglist_buttons, { spacing = 5, ssquares_resize  = true }, nil, wibox.layout.fixed.vertical())
    ...
    s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, tasklist_buttons, {}, nil, wibox.layout.flex.vertical())

    -- Create the wibox
    s.mywibox = awful.wibar({ position = "right", orientation = "north", screen = s, width = 20 })
